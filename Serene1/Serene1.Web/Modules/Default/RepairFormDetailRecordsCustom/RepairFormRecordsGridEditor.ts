...
namespace Serene1.Default {
   ...
   /* import fld =RepairFormRecordsRow.Fields*/
    ...
    export class RepairFormRecordsGridEditor extends Common.GridEditorBase<RepairFormDetailRecordsRow> {
        protected getColumnsKey() { return "ServiceAD.RepairFormDetailRecordsCustom"; }
        protected getDialogType() { return RepairFormRecordsGridDialog; }
        ...
        protected onClick(e: JQueryEventObject, row: number, cell: number): void {
            ...
            if ($(e.target).hasClass('edit-row')) {
                    ...
                    this.createEntityDialog(this.getItemType(), dlg => {
                        var dialog = dlg as RepairFormRecordsGridDialog;
