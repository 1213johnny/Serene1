...
namespace Serene1.Default {
    ...
    export class CaseServiceDataGrid extends Serenity.EntityGrid<CaseServiceDataRow, any> {
        protected getColumnsKey() { return CaseServiceDataColumns.columnsKey; }
        protected getDialogType() { return CaseServiceDataDialog; }
