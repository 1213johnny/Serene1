...
{
    public partial class AlreadyKnowEditorAttribute : CustomEditorAttribute
    {
        public const string Key = "Serene1.Editor.AlreadyKnowEditor";

        public AlreadyKnowEditorAttribute()
            : base(Key)
        {
        }
